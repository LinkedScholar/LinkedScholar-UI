        ...
        <div id="landing-content" className="landing-content" ref={contentRef}>
          ...
          <section className="section-box">
            <div className="intro-content">
              ...
              <p className="intro-description">
                LinkedScholar bridges the gap between research and real-world innovation, helping <span className="highlight-secondary">companies, startups, and institutions</span> to
                  ...
                  {[
                    {
                      ...
                      description: 'Identify emerging <span class="highlight-secondary">technologies and scientific breakthroughs</span> with the highest potential to drive business innovation before your competitors.'
                    },
                    {
                      icon: 'mdi-target',
                    ...
                    },
                    {
                      ...
                      description: 'Discover high-impact <span class="highlight-secondary">partnership opportunities</span> with research institutions and build optimal project teams using our matching algorithms.'
                    },
                    {
          ...
          <section className="support-section section-box">
            <div className="support-content">
              ...
              <p>
                LinkedScholar is more than just a platform — it's your strategic partner in navigating the future of innovation.
                We're building the intelligence infrastructure that transforms how organizations approach R&D, and we're looking for
                visionary partners who want to lead in the intelligence-driven economy.
              </p>
              <p>
                By partnering with LinkedScholar, you gain access to cutting-edge research intelligence, exclusive industry insights,
            ...
            <div className="sponsors-section">
              ...
              <p>We're proud to work with organizations that are shaping the future of innovation.</p>
