...
const AUTHOR_AUTHOR_DISTANCE = 112;
const AUTHOR_ARTICLE_DISTANCE = 200;

const AUTHOR_REPULSION = -700;
const ARTICLE_REPULSION = -250;

const AUTHOR_COLLISION_RADIUS = 30;
const ARTICLE_COLLISION_RADIUS = 10;
